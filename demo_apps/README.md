...
|---|---|---|---|
| `demo_apps/vulnerable` | 8000 | one bug per check (see its own README) | 8 findings across all 4 OWASP ids |
...
Demo Vulnerable API: 8 finding(s)
  ...
  [CRITICAL] API1:2023 Broken Object Level Authorization (BOLA) - Write Access -- PATCH /users/{user_id}
